...
At GPMD we use a Git branching model based on something called Gitflow. Full details of Gitflow can be found on [Vincent Driessen's website](http://nvie.com/posts/a-successful-git-branching-model/).
